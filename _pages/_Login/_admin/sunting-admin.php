	...
	<body onload="startTime()">
		<div class='c-main-wrapper'>
			...
			<div id='main-back-end'>
				...
				<!-- KATEGORI BODY START -->
				<div id='child-main'>
					<p id='title-main-admin' class='c-bor-bot-3 c-bor-color-yellow'>Sunting Profil Admin</p>
					<table id='add-brg' cellpadding='5' border='0' style='width:300px;'>
						<form enctype='multipart/form-data' method='post' action='../_plugin/_config/proses.php?p=sunting-admin'>
						<?php
