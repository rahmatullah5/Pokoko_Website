...
<html>
	<head>
		...
		<meta name="keywords" content="e-commerce, pokoko, TokoOnline, ILoveIndonesia, IndonesianProduct,Pembeli">
		...
		<div class='c-main-wrapper' align='center' style='margin-top:20px;'>
			<div class='c-wrapper-10'>
				<div class='c-left-side-10 c-b-a-light-grey'>
					<p class='c-font-bell c-font-15 c-text-a-left' style='padding-left:20px;padding-bottom:10px;border-bottom:1px solid #cecece;width:680px;'>Daftar Sebagai Pembeli Di Pokoko</p>
					<div id='form-d-p'>
						<form method='post' action='../_plugin/_config/proses.php?p=daftar-beli'>
						...
						<p class='c-f-left' id='jual'><a href='pages.php?pages=daftar-seller' class='c-color-light'>Daftar Sebagai Penjual</a></p>
					</div>
					<div class='c-clean'></div>	
				</div>
				<div class='c-right-side-10' style='height:360px;'>
					<div id='right-side-promo'>
						<div id='title-rsp'><p>belanja lebih mudah</p></div>
						<div id='content-rsp'>
							<ul id='ul-rsp'  class='c-b-l-light-grey'>
								...
								<li>
									...
									<p>Jaminan Perlindungan Pembeli</p>
								</li>
								<li>
									<img src="../_img/icon/trusted-seller-icon-small.png">
								...
								<a href="" class='c-trans-smooth c-hov-underline c-color-dark-blue'><p  class='c-color-dark-blue c-text-a-left' style='margin:-10px 0px 5px 10px'>Selengkapnya</p></a>
							</ul>
							<div class='c-clean'></div>
						</div>
						<div class='c-clean'></div>		
			...
			<div class='c-wrapper-10 c-back-grey' style='margin-top:0px;height:100px;'>
