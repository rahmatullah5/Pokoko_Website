			...
			<div class='c-wrapper-12'>
				<div id='left-sec-12-25' class='c-fixed' style='padding-left:10px; width:240px;'>
					<form method='post' action=''>
						...
						<div id='view-brg-nav'>
							<input type='radio' name='lih-brg' value='best'><p>Barang Terlaris</p>	
						</div>
						<div id='view-brg-nav'>
										...
										echo "
											<li>
												<a href='pages.php?pages=detail-barang&id-barang=$data_new[id]'>
													<div id='img-news' style='background: #fff url(../_img/_barang/$data_new[imgnya]) top center no-repeat;background-size:cover;'></div>
										...
										echo "
											<li>
												<a href='pages.php?pages=detail-barang&id-barang=$data_new[id]'>
													...
													<div id='goods-name-1'><p>$data_new[nama]</p><div class='c-clean'></div></div>
													<div id='goods-name-1'><span class='c-color-pink c-bold'>Rp. ".$harga_fix."</span><span class='c-color-dark-blue c-bold' style='margin-left:160px;'>$data_new[diskon]%</span><div class='c-clean'></div>
													</div>
												</a>
												<div id='add-chart-1' class='c-back-yellow'>
													<a href=''>
